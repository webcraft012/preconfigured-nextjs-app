/**
 * Custom extension of Next.js ESLint configuration
 */

// Import base Next.js ESLint config
const nextEslintConfig = require("eslint-config-next");

// Custom rule to prevent 'use server' and 'use client' directives from being used inline
const noInlineDirectivesRule = {
  meta: {
    type: "problem",
    docs: {
      description:
...
// Create a modified config that includes our custom rules
const customConfig = {
  ...nextEslintConfig,
  rules: {
    ...nextEslintConfig.rules,
    "next/no-inline-directives": noInlineDirectivesRule,
  },
};
